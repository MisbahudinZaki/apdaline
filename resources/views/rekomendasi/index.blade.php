...
<table class="table table-striped">
    ...
    <tbody>
        ...
        <form action="{{ route('rekomendasi.update', $item->id) }}" method="post">
        @csrf
        @method('PUT')
        ...
        <li>
            <form onsubmit="return confirm('apakah anda yakin?')" action="{{route('ekspedisi.destroy', $item->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('DELETE')
