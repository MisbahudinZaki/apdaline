...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
            <div class="card-header">PASAMAN PEDULI</div>
            <div class="card-body">

<form action="{{ route('cari.peduli') }}" method="get">
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{ route('peduli.store') }}" method="post">
                @csrf
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        <form action="{{ route('peduli.update', $item->id) }}" method="post">
        @csrf
        @method('PUT')
        ...
        <li><form onsubmit="return confirm('apakah anda yakin?')" action="{{route('peduli.destroy', $item->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('DELETE')
