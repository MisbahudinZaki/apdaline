...
<form action="{{ route('cari.ekspedisi') }}" method="get">
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        <li>
            <form onsubmit="return confirm('apakah anda yakin?')" action="{{route('suratmasuk.destroy', $item->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('DELETE')
