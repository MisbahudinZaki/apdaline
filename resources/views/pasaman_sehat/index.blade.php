...
<form action="{{ route('cari.berobat') }}" method="get">
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        <li><form onsubmit="return confirm('apakah anda yakin?')" action="{{route('berobat.destroy', $item->id)}}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('DELETE')
