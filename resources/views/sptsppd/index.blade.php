...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
            <div class="card-header">EKSPEDISI</div>
            <div class="card-body">

<form action="{{ route('cari.sptsppd') }}" method="get">
<input type="text" name="keyword" placeholder="Cari Surat">
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form action="{{ route('sptsppd.store') }}" method="post">
                @csrf
                ...
                <div class="form-group">
                    <label class="font-weight-bold">Perihal Surat</label>
                    <input type="text"
...
<table class="table table-striped">
    ...
    <tbody>
        ...
        <form action="{{ route('sptsppd.update', $item->id) }}" method="post">
        @csrf
        @method('PUT')
        ...
        <li>
            <form onsubmit="return confirm('apakah anda yakin?')" action="{{route('sptsppd.destroy', $item->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('DELETE')
